...
function HeroSection() {
  return (
    <section className="z-10 relative overflow-hidden bg-stars flex justify-center flex-col items-center bg-cover bg-no-repeat w-full h-screen">
      ...
      >
        Your Fractional Investment <br /> MarketPlace
      </motion.p>
      <motion.p
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        Buy, sell, and grow your Investment Portfolio with INUAA, the platform dedicated to
        every Investor at every level.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
